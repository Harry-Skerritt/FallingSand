    ...
    for (int i = 0; i < cell_amt_x; i++) {
        for (int j = 0; j < cell_amt_y; j++) {
            if (sand_grid[i][j] > 0) {
                ...
                sf::Vertex v0(sf::Vector2f(x, y), sand_colour);                         // top-left
                sf::Vertex v1(sf::Vector2f(x + sand_size, y), sand_colour);            // top-right
                sf::Vertex v2(sf::Vector2f(x + sand_size, y + sand_size), sand_colour); // bottom-right
                sf::Vertex v3(sf::Vector2f(x, y + sand_size), sand_colour);             // bottom-left
